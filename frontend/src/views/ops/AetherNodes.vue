  ...
  <div class="space-y-4">
    ...
    <div class="a-panel p-3 flex justify-between items-center bg-gray-50/50">
      <div class="flex gap-4">
        <t-input placeholder="Filter nodes by ID, IP, or Label..." class="!w-80" />
        <t-select placeholder="All Zones" class="!w-32" />
      </div>
      ...
      <table class="w-full text-left border-collapse">
        <thead>
          <tr class="text-[10px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-100 bg-gray-50/80">
            <th class="py-3 px-4 w-10"><t-checkbox /></th>
        ...
        <tbody class="divide-y divide-gray-50">
          <tr v-for="node in nodes" :key="node.id" class="hover:bg-blue-50/30 group">
            <td class="py-3 px-4"><t-checkbox /></td>
    ...
    <div class="flex justify-between items-center px-2">
      ...
      <div class="flex border border-gray-200 bg-white">
        <button class="h-8 w-8 flex items-center justify-center border-r border-gray-100 hover:bg-gray-50 text-gray-400"><t-icon name="chevron-left" /></button>
        ...
        <button class="h-8 w-8 flex items-center justify-center hover:bg-gray-50 text-gray-400"><t-icon name="chevron-right" /></button>
      </div>
    </div>
  </div>
</template>
