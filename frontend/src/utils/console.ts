...
export interface ConsoleNavItem {
  key: 'account' | 'overview' | 'users' | 'applications' | 'audit' | 'system';
  label: string;
  description: string;
  icon: string;
  to: string;
...
export const auditActionLabels: Record<string, string> = {
  'auth.email_code.login': '发了个登录验证码',
  'auth.email_code.register': '发了个注册验证码',
  'auth.email_code.reset-password': '发了个重置密码的验证码',
  'auth.login.password': '用密码登录了',
  'auth.login.email_code': '用验证码登录了',
  'auth.register': '注册了新账号',
  'auth.reset_password': '重置了密码',
  'auth.session.revoked': '注销了一个登录会话',
  'auth.sessions.revoked_others': '清理了其他登录会话',
  'auth.profile.updated': '更新了个人资料',
  'auth.phone.bound': '绑定了手机号',
  'auth.phone.unbound': '解绑了手机号',
  'oauth2.authorize': '批准了应用授权',
  'admin.user.created': '新建了个用户',
  'admin.user.password_reset': '重置了用户密码',
  'admin.user.updated': '改了用户信息',
  'admin.user.status.updated': '改了用户状态',
  'admin.user.deleted': '删了个用户',
  'admin.application.created': '新建了个应用',
  'admin.application.updated': '改了应用配置',
  'admin.application.status.updated': '改了应用状态',
  'admin.application.deleted': '删了个应用',
  'admin.application.secret_reset': '重置了应用密钥',
  'admin.social_provider.updated': '改了第三方登录配置',
  'admin.social_provider.deleted': '删除了第三方登录',
  'admin.email_config.updated': '改了邮件配置',
  'admin.backup.config_updated': '改了自动备份配置',
  'admin.backup.created': '创建了备份',
  'admin.backup.restored': '恢复了备份',
  'admin.backup.deleted': '删了备份',
};
